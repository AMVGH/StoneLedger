...
export default function EventLogs() {
  ...
  useEffect(() => {
    function handleClickOutside(e) {
      if (startDateRef.current && !startDateRef.current.contains(e.target)) setShowStartDatePopup(false);
      if (endDateRef.current && !endDateRef.current.contains(e.target)) setShowEndDatePopup(false);
    }
      ...
      <section className={styles.content}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px", flexWrap: "wrap", gap: "8px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap" }}>
            {/* Start Date Picker */}
            <div style={{ position: "relative" }} ref={startDateRef}>
              <button
                onClick={() => setShowStartDatePopup((prev) => !prev)}
                style={{
                  display: "flex",
                  alignItems: "center",
                  gap: "6px",
                  ...
                  borderRadius: "6px",
                  background: startDate ? "#e8f0fe" : "#fff",
                  cursor: "pointer",
                  fontSize: "13px",
                  color: startDate ? "#1565c0" : "#374151",
                }}
              >
              ...
              {showStartDatePopup && (
                <div style={{
                  ...
                  <input
                    type="date"
                    value={startDate}
                    onChange={(e) => { setStartDate(e.target.value); setShowStartDatePopup(false); }}
                    style={{
                      padding: "6px 10px",
                  ...
                  {startDate && (
                    <button
                      onClick={() => { setStartDate(""); setShowStartDatePopup(false); }}
                      style={{
                        padding: "6px 12px",
                        background: "#f0f4fa",
                        border: "none",
            ...
            {/* End Date Picker */}
            <div style={{ position: "relative" }} ref={endDateRef}>
              <button
                onClick={() => setShowEndDatePopup((prev) => !prev)}
                style={{
                  display: "flex",
                  alignItems: "center",
                  gap: "6px",
                  ...
                  border: "0.5px solid #d1d5db",
                  borderRadius: "6px",
                  background: endDate ? "#e8f0fe" : "#fff",
                  cursor: "pointer",
                  fontSize: "13px",
                  color: endDate ? "#1565c0" : "#374151",
                }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
              ...
              {showEndDatePopup && (
                <div style={{
                  ...
                  <input
                    type="date"
                    value={endDate}
                    onChange={(e) => { setEndDate(e.target.value); setShowEndDatePopup(false); }}
                    style={{
                      padding: "6px 10px",
                      border: "1px solid #d6dde6",
                      borderRadius: "6px",
                  ...
                  {endDate && (
                    <button
                      onClick={() => { setEndDate(""); setShowEndDatePopup(false); }}
                      style={{
                        padding: "6px 12px",
                        background: "#f0f4fa",
                        border: "none",
