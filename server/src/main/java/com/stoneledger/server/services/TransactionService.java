...
public class TransactionService {
    ...
    // TODO: Transactional Logging, Business Logic on values, entry service to record each individual entry
    @Transactional
    public boolean createJournalTransaction(TransactionCreationDTO request, MultipartFile file) throws IOException {
        ...
        transactionEntryService.saveInnerTransactionEntries(request.getCreatedBy(), entries);
